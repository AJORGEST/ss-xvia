...
*  BD Postgres   `2 vCPU [ 4 GB de RAM ]  disk 200 GB`   IP interno 
	...
	O orgão deverá disponibilizar os equipamentos com ingress na rede interna abaixo:
	...
	Comunicação entre orgãos diferente, são feita através de ip externo, dns e portas de entrada e saída criptografadas utilizando o  balanceamento de carga:
	
		DNS: xvia.xxx.mt.gov.br - IP 201.49.XXX.XX Ingress  - http 80, https 443 5500 5577
